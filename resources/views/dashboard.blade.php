            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <div>
                            @if($activity->status == 'Completed' || $activity->status == 'Ongoing' )
                            <a href="{{ route('officer.activity-details', ['activity_id' => $activity->activity_id]) }}" class="btn btn-link p-0" data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                <span class="text-500 far fa-eye"></span>
                            </a>
                            @else
                            <a href="{{ route('officer.edit', ['activity' => $activity]) }}" class="btn btn-link p-0 ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                <span class="text-500 fas fa-edit"></span>
                            </a>
                            <a href="{{ route('officer.activity-details', ['activity_id' => $activity->activity_id]) }}" class="btn btn-link p-0" data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                <span class="text-500 far fa-eye"></span>
                            </a>
                            <a href="{{ route('officer.delete', ['activity_id' => $activity->activity_id]) }}" class="btn btn-link p-0 ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
                                <span class="text-500 fas fa-trash-alt"></span>
                            </a>
                            @endif
                        </div>
