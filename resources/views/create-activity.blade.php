              ...
              <div class="card mt-3">
                <div class="card mt-3">
                  ...
                  <div class="card-body bg-body-tertiary">
                    <form method="post" id="form1" action="{{route('create-activity.store')}}" novalidate="" class=" row g-3 needs-validation dropzone dropzone-multiple p-0" id="my-awesome-dropzone" data-dropzone="data-dropzone"  enctype="multipart/form-data">
                      @csrf
                      @method('post')
                      <div class="row gx-2">
