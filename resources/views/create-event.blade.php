...
<!-- Mirrored from prium.github.io/falcon/v3.19.0/app/events/create-an-event.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Nov 2023 06:21:01 GMT -->
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        <div class="content">
          ...
          <div class="card cover-image mb-3"><img class="card-img-top" src="<?php echo 'assets/img/generic/13.jpg' ?>" alt="" /><input class="d-none" id="upload-cover-image" type="file" /><label class="cover-image-file-input" for="upload-cover-image"><span class="fas fa-camera me-2"></span><span>Change cover photo</span></label></div>
          <div class="row g-0">
